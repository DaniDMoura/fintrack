...
public class SummaryService {
    ...
    public SummaryService(FindAuthenticatedUser findAuthenticatedUser, ExpenseRepository expenseRepository, IncomeRepository incomeRepository) {
    ...
    public SummaryResponse getSummary(String month) {
        ...
        BigDecimal totalExpenses =
                expenseRepository.sumByUserAndCreatedAtBetween(
                        user,
                        start,
                        end
                );
        ...
        BigDecimal balance = income.subtract(
