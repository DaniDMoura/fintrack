...
public class ExpenseService {
    ...
    public ExpenseService(ExpenseRepository expenseRepository, ExpenseMapper expenseMapper, FindAuthenticatedUser findAuthenticatedUser) {
    ...
    public ExpenseResponse createExpense(ExpenseRequest expenseRequest) {
        ...
        Expense savedExpense = expenseRepository.save(
                expenseMapper.toExpenseEntity(expenseRequest, user)
        );
    ...
    public ExpenseResponse findExpenseByIdAndCurrentUser(Long expenseId) {
        ...
        return expenseMapper.toExpenseResponse(
                expenseRepository.findByIdAndUser(user, expenseId).orElseThrow(ExpenseNotFoundException::new)
        );
    ...
    public ExpenseResponse updateExpense(Long expenseId, @Valid ExpenseRequest expenseRequest) {
        User user = findAuthenticatedUser.getAuthenticatedUser();
        Expense expense = expenseRepository.findByIdAndUser(user, expenseId).orElseThrow(ExpenseNotFoundException::new);
