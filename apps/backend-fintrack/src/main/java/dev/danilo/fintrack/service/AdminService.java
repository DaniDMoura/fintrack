...
public class AdminService {
    ...
    public AdminService(UserRepository userRepository, ExpenseRepository expenseRepository, IncomeRepository incomeRepository, UserMapper userMapper, ExpenseMapper expenseMapper, IncomeMapper incomeMapper) {
    ...
    public List<ExpenseResponse> getAllExpenses(Long userId, String month) {
        ...
        return expenseRepository
                .findWithFilters(userId, start, end)
                .stream()
