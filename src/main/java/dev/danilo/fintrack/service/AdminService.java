...
public class AdminService {
  ...
  public List<ExpenseResponse> getAllExpenses(Long userId, String month) {
    ...
    return expenseRepository.findWithFilters(userId, yearMonth).stream()
  ...
  public List<IncomeResponse> getAllIncomes(Long userId, YearMonth yearMonth) {
    return incomeRepository.findWithFilters(userId, yearMonth).stream()
